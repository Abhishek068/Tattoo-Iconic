...
export default function PortfolioPage() {
  // Active Tab: 'masterpieces' | 'instagram' | 'moodboard'
  ...
  // Load Initial Data & Moodboard from localStorage
  useEffect(() => {
    portfolioService
      .getPortfolio({
        style: selectedStyle,
  ...
  return (
    <>
      ...
      <main className="container-hero py-10 sm:py-16 min-h-screen">
        ...
        {/* ── Search & Filter Bar (Active for Masterpieces & Inspiration) ── */}
